...
-- Export Date: 2025-10-27 18:33:51
...
INSERT INTO `super_admin` (`id`, `username`, `password`, `email`, `department`, `status`, `created_at`, `updated_at`, `is_permanent`) VALUES ('43', 'superadmin', '$2y$10$ieaI73Hqf0OwOSBjU84CduIyJyC./i0Miu4JABciLwQirVbqTn9OG', 'roycepigao@gmail.com', NULL, 'active', '2024-01-01 00:00:00', '2025-10-28 01:25:21', '1');
...
-- Data for table user_sessions (5 rows)
...
INSERT INTO `user_sessions` (`id`, `user_id`, `session_id`, `ip_address`, `user_agent`, `login_time`, `last_activity`, `is_active`) VALUES ('102', '43', '9usgbugnhkmnf3tik3qt3fvsk5', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/141.0.0.0 Safari/537.36 Edg/141.0.0.0', '2025-10-28 01:25:21', '2025-10-28 01:25:24', '1');
...
VALUES ('superadmin', 'roycepigao@gmail.com', '$2y$10$l8Ae.u5F/OddGMcwX17VvOuc4sVdRFVcV9imjmgKMOwHuS593ilCa', 'IT Department', 'active', 1, '2024-01-01 00:00:00')
ON DUPLICATE KEY UPDATE 
    email = 'roycepigao@gmail.com',
    password = '$2y$10$l8Ae.u5F/OddGMcwX17VvOuc4sVdRFVcV9imjmgKMOwHuS593ilCa',
